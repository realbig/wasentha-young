...
function releaseCopy() {
    ...
    return gulp.src([
        ...
        'core/library/**/*',
        'includes/**/*',
        '!includes/rbp-support/{build,build/**}',
        '!includes/rbp-support/{gulp,gulp/**}',
        '!includes/rbp-support/{node_modules,node_modules/**}',
        '!includes/rbp-support/**/*.zip',
